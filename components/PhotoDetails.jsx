    ...
    return (
        <div className="grid grid-cols-12 gap-4 2xl:gap-10 ">
            <div className="col-span-12 lg:col-span-8 border rounded-xl">
                <Image className="max-w-full h-full max-h-[70vh] mx-auto" width={600} height={600} src={photo.url} alt={photo.title} />
            </div>
                ...
                <div className="mt-6">
                    <div className="flex justify-between items-center mb-3">
                        <div className="flex items-center gap-3">
                            <Image width={600} height={600} className="size-12 lg:size-14 rounded-full border" src={photo.author.avatar} alt="avatar" />
                        ...
                        <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
                            <Image width={600} height={600} alt="image" src="/follow.svg" className="w-5 h-5" />
                            {dictionary.follow}
                        </button>
                    </div>
                ...
                <div className="mt-6">
                    <div className="flex items-stretch gap-3">
                        <button
                            ...
                            <Image width={100} height={100} alt="image" src="/heart.svg" className="w-5 h-5" />
                            100
                        </button>
                        <button
                            className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
                            <Image width={100} height={100} alt="image" src="/save.svg" className="w-5 h-5" />
                            Save
                        </button>
                        <button
                            className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
                            <Image width={100} height={100} alt="image" src="/share.svg" className="w-5 h-5" />
